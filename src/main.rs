...
fn main() {
    ...
    println!("day08-1: {}", day08::part1(&input("day08")));
    println!("day08-2: {}", day08::part2(&input("day08")));
    println!("day09-1: {}", day09::part1(&input("day09")));
    println!("day09-2: {}", day09::part2(&input("day09")));
}
